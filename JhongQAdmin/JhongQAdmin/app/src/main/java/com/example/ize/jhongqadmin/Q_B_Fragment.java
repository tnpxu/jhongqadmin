 ...
 * Use the {@link Q_B_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Q_B_Fragment extends android.support.v4.app.Fragment {
    ...
    public AcceptSkipStandByQueue queueBStandby;
     ...
     * @return A new instance of fragment Q_B_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Q_B_Fragment newInstance(String param1, String param2,String rn , String rb,String test) {
        Q_B_Fragment fragment = new Q_B_Fragment();
    ...
    public View onCreateView(final LayoutInflater inflater,final ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_q_b_, container, false);
        lview = (ListView) view.findViewById(R.id.Fragment_QB_listView);
        MyApplication myApplication = ((MyApplication)getActivity().getApplicationContext());
        listadapt = myApplication.listadaptB;
        listQWait = myApplication.toTalQueueWaitB;
        Integer toTalQueueWait = listQWait.get(0);

        //show top red character !!
        texViewTotal =(TextView) view.findViewById(R.id.Fragment_QB_txt_numSumQ);
        texViewTotal.setText("" + toTalQueueWait.intValue());

        if(!(listadapt.isEmpty())) {
        QueueListData standBy = listadapt.get(0);
        texViewNum =(TextView) view.findViewById(R.id.Fragment_QB_txt_CurQ);
        texViewNum.setText(standBy.getQueuenum() + standBy.getQueuetype());
            ...
            texViewName = (TextView) view.findViewById(R.id.Fragment_QB_txt_CusName);
...
//        return inflater.inflate(R.layout.fragment_q_a_, container, false);
    }
...
//                                            ArrayList<QueueListData> listadaptGet = myApplication.listadaptB;
//                                            ArrayList<Integer> listQWaitGet = myApplication.toTalQueueWaitB;
                                                    ...
                                                    if (listadapt.size() > 0) {
                                                        ...
                                                        if((texViewNum) != null && (texViewName != null)) {
                                                            if (standBy.getNickname() != null) {
                                                                texViewNum.setText(standBy.getQueuenum() + standBy.getQueuetype());
                                                                texViewName.setText("( " + standBy.getNickname() + " , " + "4-6 ท่าน" + " )");
                                                            } else {
